pro run_gort
 ...
 tek_color
  ...
  device, file= 'rw_f_fp.eps', /TIMES,/BOLD,/portrait, ysize=28, YOFFSET=0, xsize=21, xOFFSET=0.0
  !p.multi=[0,3,3]

nsite = 9
;indir = '/data/shared/src/STV/LidarSimulation/OrigGORTInput/redwood/*.in'
indir = '/data/shared/src/STV/LidarSimulation/OrigGORTInput/2024_06_26/redwood/origB10th/*.in'
...
;   print,ilevel
  ...
  close, 2
  plot, fp, ght,title='RW/L/'+strmid(fplot(i-1),66+21,3),xtitle='Foliage Profile (m^2/m^3)', ytitle='Height(m)', xrange=[jx1,jx2], yrange=[jh1,jh2],charsize=cs,charthick=ct
endfor
DEVICE,/CLOSE 
stop
end
