pro run_gort
 ...
 tek_color
  ...
  device, file= 'fg_f_afp.eps', /TIMES,/BOLD,/portrait, ysize=28, YOFFSET=0, xsize=21, xOFFSET=0.0
  !p.multi=[0,3,3]

nsite = 9
;indir = '/data/shared/src/STV/LidarSimulation/OrigGORTInput/2024_06_20/guiana/*.in'
indir = '/data/shared/src/STV/LidarSimulation/OrigGORTInput/2024_06_26/guiana/origLD10th/*.in'
...
;read gort output file 
  ...
  readf, 2, temp_str
  readf, 2, temp_str1
  print, strmid(fplot(i-1),76+11,3), ' ', temp_str, temp_str1
...
; print, total(fp,/CUMULATIVE)*dz
  ...
  plot, total(fp,/CUMULATIVE)*dz, ght,title='FG/L/'+ strmid(fplot(i-1),76+11,3),xtitle='Accumulated FP', ytitle='Height(m)', xrange=[jx1,jx2], yrange=[jh1,jh2],charsize=cs,charthick=ct
endfor
DEVICE,/CLOSE 
stop
end
