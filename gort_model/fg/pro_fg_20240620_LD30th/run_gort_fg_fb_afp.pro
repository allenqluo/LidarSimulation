...
; print, total(fp,/CUMULATIVE)*dz
  ...
  plot, total(fp,/CUMULATIVE)*dz, ght,title='FG/B+L/'+ strmid(fplot(i-1),88,3),xtitle='Accumulated FP', ytitle='Height(m)', xrange=[jx1,jx2], yrange=[jh1,jh2],charsize=cs,charthick=ct
endfor
DEVICE,/CLOSE 
stop
end
