...
;   print,ilevel
  ...
  close, 2
  plot, fp, ght,title='FG/B+L/'+ strmid(fplot(i-1),88+5,3),xtitle='Foliage Profile (m^2/m^3)', ytitle='Height(m)', xrange=[jx1,jx2], yrange=[jh1,jh2],charsize=cs,charthick=ct
endfor
DEVICE,/CLOSE 
stop
end
