pro run_gort
 ...
 tek_color
  ...
  device, file= 'fg_fb_fp.eps', /TIMES,/BOLD,/portrait, ysize=28, YOFFSET=0, xsize=21, xOFFSET=0.0
  !p.multi=[0,3,3]
...
;   print,ilevel
  ...
  close, 2
  plot, fp, ght,title='FG/B+L/'+ strmid(fplot(i-1),72,3),xtitle='Foliage Profile (m^2/m^3)', ytitle='Height(m)', xrange=[jx1,jx2], yrange=[jh1,jh2],charsize=cs,charthick=ct
endfor
DEVICE,/CLOSE 
stop
end
